      ...
      <div className="w-full text-center">
        <div className="h-full">
          <div className="flex items-center justify-center">
            <h1 className="text-3xl md:text-7xl bg-clip-text m-3 text-transparent bg-gradient-to-r from-orange-700 to-yellow-700 font-extrabold">
              Why Solar? <br />
            </h1>
          </div>
          <div className="flex items-center justify-center">
            <h1 className="h-full text-3xl md:text-6xl bg-clip-text m-3 text-transparent bg-gradient-to-r from-yellow-600 to-green-700 font-extrabold">
              {typeEffect}
            </h1>
          </div>
        </div>
